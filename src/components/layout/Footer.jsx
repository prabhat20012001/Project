...
export default function Footer() {
  return (
    <>
      {/* ========== Footer ========== */}
      <footer className="bg-[#8EE5DC] py-14 border-b-[1px] font-medium">
        <div className="container mx-auto space-y-6 sm:grid sm:grid-cols-2 sm:gap-4 sm:space-y-0 lg:grid-cols-4">
          <div className="sm:p-4">
            <p className="text-md leading-5">
              ...
              Consectetur debitis voluptates culpa perspiciatis nesciunt
              laudantium! Fuga molestiae exercitationem in eius totam deserunt
              possimus
            </p>
          ...
          <div className="sm:p-4">
            <h4 className="text-3xl font-semibold mb-6">Location</h4>
            <p className="text-md leading-5">
              <a href="#">
                Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                Sapiente, hic.
