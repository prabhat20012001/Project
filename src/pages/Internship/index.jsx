...
import {internshipHeader,internshipIcon1,internshipIcon2,internshipIcon3,internshipIcon4,internshipIcon5,internshipTestimonial,internshipWhy, iconCommitment, iconFacilities, iconExperience} from "../../assets";
...
export default function Index() {
   ...
   <>
      ...
      <div className="flex flex-col md:flex-row justify-center items-center">
        ...
        <div className="md:w-1/2 text-center md:text-left px-4 space-y-2">
          <h1 className='subheading heading-primary'>Looking for an Internship.</h1>
     ...
     {/* ==== why wleness===== */}
        ...
        <div >
          <hgroup className="items-center lg:text-center">
            <h2 className="subheading heading-primary text-center ">Why Wleness?</h2>
          </hgroup>
        </div>
      ...
      <div>
        <h1 className='subheading heading-primary '>Want to know what it's like to work at WLENESS</h1>
        <div className="grid mt-4 grid-cols-5 items-center gap-4">
  {/* Icon-1 */}
  <div className="h-74 items-center p-2 shadow-2xl h-full rounded-xl">
    <img src={internshipIcon1} alt="Icon 1" className='mx-auto py-4' />
    <h3 className="text-primary-400 font-bold">Kill deadlines, not your mental health:</h3>
    <p className="font-semibold">Flexible timings for your Flexible creativity</p>
  </div>

  {/* Icon-2 */}
  <div className="h-74 items-center p-2 shadow-2xl h-full rounded-xl">
    <img src={internshipIcon2} alt="Icon 2" className='mx-auto py-4' />
    <h3 className="text-primary-400 font-bold">The perfect work-life balance:</h3>
    <p className="para">We work as a family where your priority matters to us.</p>
  </div>

  {/* Icon-3 */}
  <div className="h-74 items-center p-2 shadow-2xl h-full rounded-xl">
    <img src={internshipIcon3} alt="Icon 3" className='mx-auto' />
    <h3 className="text-primary-400 font-bold">We spread smiles, not stress:</h3>
    <p className="para">Unleash a perfect state of mind sans anxiety or stress</p>
  </div>

  {/* Icon-4 */}
  <div className="h-74 items-center p-2 shadow-2xl h-full rounded-xl">
    <img src={internshipIcon4} alt="Icon 4"  className='mx-auto py-5'/>
    <h3 className="text-primary-400 font-bold">Break mental health barriers:</h3>
    <p className="para">Well-being rules with wit, passion, and positive vibes!</p>
  </div>
  ...
  <div className="h-74 items-center p-2 shadow-2xl h-full rounded-xl">
    ...
    <h3 className="text-primary-400 font-bold">The perfect Work-Life balance:</h3>
    <p className="para">Conquer the stigma, spread love and compassion.</p>
  </div>
</div>
      ...
      {/* Listen to their stories. */}
       <div className='container  mx-auto py-6 '>
        <h1 className='subheading heading-primary py-4 text-center'>Listen to their stories.</h1>
              <div className='flex items-center py-6 '>
                      <div className='w-2/5 '>
                      <img src={internshipTestimonial} className="w-full h-96 object-contain" />

                      </div>

                        <div className='w-3/5  pr-0'>
                          <h3 className='text-teal-400 font-bold text-2xl'>Leena Paxton</h3>
                          <h4>UI/UX Designer</h4>
                          <p className='para py-10'>“Wleness provided an exceptional internship experience that exceeded my expectations. The supportive team, meaningful projects, and commitment to personal development made it a transformative journey for my career growth. Highly recommend!</p>
                        </div>
