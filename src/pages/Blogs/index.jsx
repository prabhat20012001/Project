...
import{blogHeader1,blogHeader2,blogRecent,blogThumbnail1,blogThumbnail2,blogThumbnail3,blogThumbnail4,blogThumbnail5,blogThumbnail6} from "../../assets"
      ...
      {/* ==========our blogs============= */}
          <div className='bg-primary-50/30 rounded-xl flex items-center'>
            ...
            <div>
               ...
               <p>Mental health and physical health are linked, with poor mental health leading to physical health problems and vice versa. This blog post explores the relationship and offers tips for how to prioritize both in daily life.</p>
            </div>
            <div className=''>
              <img src={blogHeader2} className='h-fit' >
              </img>
            </div>
